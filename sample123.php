...
if(isset($_POST['Register'])){
  ...
  // Email verification
  $verify_query = mysqli_query($con, "SELECT * FROM student WHERE email = '$email'");
  if(mysqli_num_rows($verify_query) != 0){
     ...
     $insert_query = "INSERT INTO student (first_name, last_name, college_name, email, mobile_number, gender, state, course)
                      VALUES ('$first_name', '$last_name', '$college_name', '$email', '$mobile_number', '$gender', '$state', '$course')";
     mysqli_query($con, $insert_query) or die("Error Occurred");
  }
